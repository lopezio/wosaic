 ...
 * @author scott
 */
public class WosaicApp extends JFrame {
	...
	public class GenerateMosaicAction extends AbstractAction {
		...
		public void actionPerformed(final ActionEvent evt) {
			...
			final WosaicApp wos = (WosaicApp) parent;
			final int numThrds = WosaicApp.THREADS;
			int target = WosaicApp.TARGET;
	...
	public class OpenFileAction extends AbstractAction {
		...
		public void actionPerformed(final ActionEvent evt) {
			...
			((WosaicApp) parent).FileField.setText(file.getAbsolutePath());
		}
	}
