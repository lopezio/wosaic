...
public class FlickrService extends SourcePlugin {
    ...
    /**
         * Static constructor-- initialize our Flickr API and connection to
         * Flickr
         */
    static {
	// Connect to flickr
    ...
    /**
         ...
         * to the Flickr API. Note that a new FlickrService should be
         * initialized for each new search query.
         * 
    ...
    /**
         * In a new thread, start queuing child threads to query Flickr for
         * results. The results will be saved in SourcesBuffer, and
         * SourcesBuffer.isComplete will be set when it is complete
         * 
