...
public class Controller implements Runnable {
    ...
    private Vector<SourcePlugin> Plugins;
    ...
    /**
         ...
         * @param mos
         *                a reference to the mosaic object which will be
         *                operated on
         * @param fb
         *                a flag that indicates whether or not to use facebook.
         *                This should be replaced by a vector indicating which
         *                Plugins to use, as we incorporate more Plugins.
         */
