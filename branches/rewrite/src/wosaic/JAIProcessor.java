...
public class JAIProcessor implements Runnable {
    ...
    /**
         * A reference to the controller object. This is needed for access to
         * the shared buffer.
         */
    ...
    /**
         ...
         *                mosaic parameters
         * @param buf
         *                reference to a shared buffer that contains images to
         *                be processed
         * @param mos
         * @param stat
         *                a reference to a shared status object
         */
    public JAIProcessor(final Pixel mPixel, final Parameters param, final ImageBuffer buf,
	    final Mosaic mos, final Status stat) {
	params = param;
	master = mPixel;
	sourcesBuffer = buf;
	mosaic = mos;
    ...
    /**
         ...
         */
    public int[][][] analyzeSegments(final int numRows, final int numCols, final int width,
	    final int height, final Pixel mPixel) {
